    ...
    return(
        ...
        <div className='container about-page'>
            <div className='text-zone'>
                ...
                <p>
                Game Director, Game Designer & Project Manager, Madrid Director behind the entire development process of Poky Drivers for iOS & Android, from setting up the office, hiring staff, full game design, level design, art and pipeline design. Currently running competitive arcade racing
                game.
                </p>
                <p>
                    {' '}
